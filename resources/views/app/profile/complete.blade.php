                ...
                <section class="col">
                    ...
                    <section class="row mt-4">
                        <section class="col-md-9">
                            <form id="profile-complete" action="{{route('profile.update.complete')}}" method="post"
                                ...
                                <section class="payment-alert alert alert-primary d-flex align-items-center p-2"
                                    ...
                                    <section>
                                        اطلاعات حساب کاربری خود را کامل وارد کنید. کالاها برای شخصی با این مشخصات ارسال
                                        می شوند.
                                    </section>
                                </section>
                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                ...
                                <section class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="text-muted"><span
                                            id="final-product-prices">{{ priceFormat($finalProductPrices) }}</span> تومان
                                    </p>
                                </section>
                                ...
                                <section class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="fw-bolder"><span
                                            id="total-product-prices">{{ priceFormat($totalProductPrices) }}</span> تومان</p>
                                </section>
                                ...
                                <section class="">
                                    <button type="button"
                                            onclick="document.getElementById('profile-complete').submit();"
