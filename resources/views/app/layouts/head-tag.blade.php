<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-3HCB7WM4K5"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-3HCB7WM4K5');
</script>
<meta charset="utf-8">
...
<link rel="stylesheet" href="{{asset('app-assets/fontawesome/css/all.css')}}">
