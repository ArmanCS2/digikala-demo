                        ...
                        <section class="d-inline px-md-3">
                            ...
                            <section class="dropdown-menu dropdown-menu-end custom-drop-down"
                                ...
                                <section><a class="dropdown-item" href="{{route('profile.index')}}"><i
                                        ...
                                        کاربری</a></section>
                                <section><a class="dropdown-item" href="{{route('profile.orders')}}"><i class="fa fa-newspaper"></i>سفارشات</a>
                                </section>
                                <section><a class="dropdown-item" href="{{route('profile.favorites')}}"><i class="fa fa-heart"></i>لیست
                        ...
                        <section class="header-cart-dropdown">
                            ...
                            @auth
                                ...
                                <section
                                    ...
                                    <section class=""><a class="btn btn-danger btn-sm d-block" href="{{route('market.cart')}}">ثبت
                                            سفارش</a></section>
                                </section>
                            @endauth
                            @guest
        ...
        <section class="container-xxl ">
            <nav class="">
                <section class="d-none d-md-flex justify-content-md-start position-relative">
                    ...
                    <section class="navbar-item"><a href="https://armanafzali.ir">سوپرمارکت</a></section>
                    <section class="navbar-item"><a href="https://armanafzali.ir">تخفیف ها و پیشنهادها</a></section>
                    <section class="navbar-item"><a href="https://armanafzali.ir">آمازون من</a></section>
                    <section class="navbar-item"><a href="https://armanafzali.ir">آمازون پلاس</a></section>
