...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> ایجاد پست جدبد</li>
        </ol>
    </nav>
                                    ...
                                    <select name="category_id" id="" class="form-control form-control-sm">
                                        ...
                                        @foreach($postCategories as $postCategory)
                                            <option
                                                ...
                                                @if($postCategory->id == old('category_id')) selected @endif>{{$postCategory->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('category_id')
