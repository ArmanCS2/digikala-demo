                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($banners as $key => $banner)
                            <tr>
                                ...
                                <td>{{$banner->title}}</td>
                                <th>{{$banner->url}}</th>
                                <td><img src="{{asset($banner->image)}}"
                                         width="100"></td>
                                <td>{{$positions[$banner->position]}}</td>
                                <td>
                                    <label>
                                        <input type="checkbox" id="change_status_{{$banner->id}}"
                                               onchange="changeStatus({{$banner->id}})"
                                               data-url="{{route('admin.content.banner.ajax.change-status',[$banner->id])}}"
