                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <label>
                                    <input type="checkbox" id="change_status_{{$comment->id}}"
                                           ...
                                           data-url="{{route('admin.content.comment.ajax.change-status',[$comment->id])}}"
                            ...
                            <td class="width-22-rem text-left">
                                ...
                                @else
                                <a href="{{route('admin.content.comment.approved',[$comment->id])}}" class="btn btn-warning btn-sm"><i class="fa fa-clock"></i> عدم تایید</a>
                                @endif
