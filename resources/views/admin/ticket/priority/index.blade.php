...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page">اولویت ها</li>
        </ol>
    </nav>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($priorities as $key => $priority)
                            <tr>
                                ...
                                <td>
                                    <label>
                                        <input type="checkbox" id="change_status_{{$priority->id}}"
                                               onchange="changeStatus({{$priority->id}})"
                                               data-url="{{route('admin.ticket.priority.ajax.change-status',[$priority->id])}}"
                                ...
                                <td class="width-16-rem text-left">
                                    ...
                                    <form action="{{ route('admin.ticket.priority.destroy',[$priority->id]) }}"
