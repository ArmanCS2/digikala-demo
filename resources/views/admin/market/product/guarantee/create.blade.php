...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> افزودن گارانتی جدید</li>
        </ol>
    </nav>
    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="mx-4">
                    <form action="{{route('admin.market.product.guarantee.store',[$product->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
