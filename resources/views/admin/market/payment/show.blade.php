            ...
            <section class="main-body-container">
                ...
                <section class="card mb-3">
                    ...
                    <section class="card-body">
                        ...
                        <p class="card-text">شماره تراکنش : {{$payment->paymentable->transaction_id ?? 'پرداخت در محل'}}</p>
                        ...
                        <p class="card-text">دریافت کننده وجه : {{$payment->paymentable->cash_receiver ?? 'فروشگاه'}}</p>
                    </section>
                </section>
