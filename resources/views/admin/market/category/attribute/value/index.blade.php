        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{ route('admin.market.category.attribute.value.create',[$attribute->id]) }}"
                       class="btn btn-info btn-sm">ایجاد مقدار فرم کالا</a>
                        ...
                        @foreach($attribute->values as $key => $value)
                            <tr>
                                ...
                                <td class="width-22-rem text-left">
                                    <a href="{{route('admin.market.category.attribute.value.edit',[$value->id])}}"
                                       class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> ویرایش</a>
                                    <form
                                        action="{{route('admin.market.category.attribute.value.destroy',[$value->id])}}"
