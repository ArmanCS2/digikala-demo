...
class PaymentController extends Controller
{
    ...
    {
        $payments = Payment::where('paymentable_type', 'App\Models\Market\OnlinePayment')->orderBy('created_at', 'DESC')->paginate(20);
        return view('admin.market.payment.index', compact('payments'));
    }
    ...
    {
        $payments = Payment::where('paymentable_type', 'App\Models\Market\OfflinePayment')->orderBy('created_at', 'DESC')->paginate(20);
        return view('admin.market.payment.index', compact('payments'));
    }
    ...
    {
        $payments = Payment::where('paymentable_type', 'App\Models\Market\CashPayment')->orderBy('created_at', 'DESC')->paginate(20);
        return view('admin.market.payment.index', compact('payments'));
    }
